        ...
        <div class="row medium-padding120 bg-border-color">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="order">
                            <h3 class="h3 order-title align-center " style="color: #4CC2C0;"><a href="data:image/png;base64, {!! base64_encode(QrCode::format('png')->size(300)->generate($uda))!!}"s>Click Here To Download The Ticket</a></h3>
                            <div class="cart-main">
